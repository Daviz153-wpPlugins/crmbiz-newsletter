...
define('CRMBIZ_NL_VERSION', '0.9.21');
...
register_deactivation_hook(__FILE__, function () {
    CRMBizNewsletter\Scheduler::unscheduleAll('crmbiz_nl_send_newsletter');
    CRMBizNewsletter\Scheduler::unscheduleAll('crmbiz_nl_cleanup');
});
